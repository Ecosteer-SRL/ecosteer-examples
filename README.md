...
- an upgraded implementation <b>with</b> DVCO capabilities, that implements the necessary calls to the DVCO pub stack APIs and <b>dopifies</b> (applies end to end encryption for multicast scenarios) the data streams  (python: dvco_sensor.py, Micropython: st_sm_sens_dop.py)
